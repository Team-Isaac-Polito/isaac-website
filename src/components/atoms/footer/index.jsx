		...
		<footer className="grid grid-rows-2 font-Raleway text-[20px] h-[500px] bg-dark-blue w-full text-white">
			<div className="grid grid-cols-2 mx-[175px] my-[70px]" >
				<div className="grid grid-rows-2">
					...
					<div className="flex flex-rows h-[150px]">
						<a href=""><Instagram alt="Instagram" className="h-[40px] mx-[10px]" /></a>
						<a href=""><LinkedIn className="w-[80px] mx-[10px]" /></a>
						<a href=""> <Mail className="h-[40px] mx-[10px] hover:fill-yellow" /></a>	
					</div>
				...
				<div className="grid grid-cols-4">
					<div>
						<h6 className="text-light-blue">Home</h6><br/>						
						<a href="">About</a><br/>
					...
					<div>
						<h6 className="text-light-blue">About</h6><br/>
						<a href="">Mission</a><br/>
						<a href="">Team</a><br/>
						<a href="">Storia</a><br/>
						<a href="">Timeline</a>		
					...
					<div>
						<h6 className="text-light-blue">Progetti</h6><br/>	
						<a href="">Rase.Q</a>	
					</div>

					<div>
						<h6 className="text-light-blue">Eventi</h6><br/>
			...
			<div className="grid grid-cols-2 mx-[175px] my-[120px]">
				...
				<div className="flex flex-rows">
					<a href=""><Segnaposto className="my-[20px]"/> </a>
					<div>
