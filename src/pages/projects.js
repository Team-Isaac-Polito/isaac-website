  ...
  return (
    <div>
      ...
      <div className="w-full">
        <div className="grid grid-cols-2 w-full text-dark-blue-isaac py-[100px] bg-white">
          <div className=" ml-[150px] mt-0 w-fit h-fit">
            <Title className="text-light-blue-isaac">Caratteristiche</Title>
            <div className="my-10">Ciao</div>
            <Button text="Learn more" />
          </div>
          <div>
            <div className="flex flex-row rounded-lg  bg-light-blue-isaac h-fit mb-6 py-3 w-[529px] m-auto">
              <h2 className="ml-4 font-extrabold uppercase text-white align-left">
                Scheda tecnica
              </h2>
            </div>
